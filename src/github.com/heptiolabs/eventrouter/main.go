...
func loadConfig() kubernetes.Interface {
	...
	viper.AddConfigPath("/Users/kongyi/Workspace/Golang/eventrouter/src/github.com/heptiolabs/eventrouter/")
	viper.AddConfigPath(".")
	viper.SetDefault("kubeconfig", "")
	viper.SetDefault("sink", "glog")
	viper.SetDefault("resync-interval", time.Minute*1)
	viper.SetDefault("enable-prometheus", false)
...
func main() {
	...
	specifyInfomerFactoryNameSpace :=informers.WithNamespace("default")
	//sharedInformers := informers.NewSharedInformerFactory(clientset, viper.GetDuration("resync-interval"))
	sharedInformers :=informers.NewSharedInformerFactoryWithOptions(clientset,viper.GetDuration("resync-interval"),specifyInfomerFactoryNameSpace)
	...
	eventRouter := NewEventRouterTest(clientset, deploymentInformer)
	stop := sigHandler()
	...
	//fmt.Println("Starting shared Informer.....")
